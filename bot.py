...
OWNER_CHAT_ID = 8776640441  # Owner chat ID for file forwarding & buy redirect
FORCE_CHANNEL = "@https://t.me/Rajworldshadow"  # Channel username (with @)
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        ...
        f"├ 🔒 Isolated containers per bot\n"
        f"├ 📊 200MB RAM & 250MB Storage/bot\n"
        f"├ 🆓 2 Free bot slots\n"
